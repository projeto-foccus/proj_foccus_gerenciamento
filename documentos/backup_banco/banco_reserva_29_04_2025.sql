...
-- Copiando dados para a tabela sap_tea.aluno: ~50 rows (aproximadamente)
...
INSERT INTO `escola` (`esc_id`, `esc_dtcad`, `esc_inep`, `esc_cnpj`, `esc_razao_social`, `esc_endereco`, `esc_bairro`, `esc_municipio`, `esc_cep`, `esc_uf`, `esc_telefone`, `esc_email`, `fk_org_esc_id`) VALUES
	(1, '2025-04-29', '12375642', '10.424.655/0001-40', 'Foccus Editora e Serviços', 'Rua Norivaldo Martins da Silva', 'Retiro', 'Jundiaí', '13211-241', 'SP', '(11) 2449-1962', 'suporte@foccuseditora.com.br', NULL),
	(2, '2025-04-29', '12345678', '12.345.678/0001-90', 'Colégio Estrela do Saber', 'Rua das Flores, 120', 'Jardim Primavera', 'Campinas', '13045-678', 'SP', '(19) 3345-6789', 'contato@estreladosaber.edu.br', NULL),
	(3, '2025-04-29', '23456789', '23.456.789/0001-80', 'Escola Integração Moderna', 'Avenida Brasil, 1020', 'Centro', 'Curitiba', '80010-000', 'PR', '(41) 3234-5678', 'secretaria@integracaomoderna.com.br', NULL),
	(4, '2025-04-29', '34567890', '34.567.890/0001-70', 'Instituto Horizonte Azul', 'Rua das Palmeiras, 555', 'Boa Vista', 'Recife', '52060-001', 'PE', '(81) 3123-4567', 'contato@horizonteazul.edu.br', NULL),
	(5, '2025-04-29', '45678901', '45.678.901/0001-60', 'Centro Educacional Nova Geração', 'Rua do Comércio, 250', 'Centro', 'Florianópolis', '88010-300', 'SC', '(48) 3222-1234', 'atendimento@novageracao.edu.br', NULL),
	(6, '2025-04-29', '56789012', '56.789.012/0001-50', 'Escola Vida e Saber', 'Rua das Acácias, 45', 'Vila Nova', 'Salvador', '40240-000', 'BA', '(71) 3322-4567', 'contato@vidaesaber.com.br', NULL),
	(7, '2025-04-29', '67890123', '67.890.123/0001-40', 'Colégio Raízes do Futuro', 'Avenida Central, 890', 'Nova Esperança', 'Manaus', '69050-100', 'AM', '(92) 3234-7890', 'secretaria@raizesdofuturo.edu.br', NULL),
	(8, '2025-04-29', '78901234', '78.901.234/0001-30', 'Escola Nova Visão', 'Rua da Paz, 350', 'Jardim América', 'Goiânia', '74080-010', 'GO', '(62) 3212-3456', 'contato@novavisao.com.br', NULL),
	(9, '2025-04-29', '89012345', '89.012.345/0001-20', 'Instituto Alfa e Ômega', 'Rua Aurora, 678', 'Santa Luzia', 'Fortaleza', '60040-000', 'CE', '(85) 3456-7890', 'secretaria@alfaeomega.edu.br', NULL),
	(10, '2025-04-29', '90123456', '90.123.456/0001-10', 'Centro Educacional Saber Mais', 'Rua do Sol, 200', 'Morada Nova', 'Porto Alegre', '90010-200', 'RS', '(51) 3345-6789', 'contato@sabermais.com.br', NULL),
	(11, '2025-04-29', '', '', ' ', '', '', '', '', '', '', '', NULL);
...
INSERT INTO `funcionario` (`func_id`, `inep`, `func_nome`, `func_cpf`, `email_func`, `func_cod_funcao`) VALUES
	(1, '12375642', 'Adriana Souza Lima', '123.456.789-00', 'adriana.lima@escola.edu.br', 1),
	(2, '12375642', 'Bruno Henrique Duarte', '234.567.890-11', 'bruno.duarte@escola.edu.br', 1),
	(3, '12375642', 'Camila Oliveira Nunes', '345.678.901-22', 'camila.nunes@escola.edu.br', 1),
	(4, '12375642', 'Daniel Teixeira Ramos', '456.789.012-33', 'daniel.ramos@escola.edu.br', 1),
	(5, '12375642', 'Elisa Martins Barreto', '567.890.123-44', 'elisa.barreto@escola.edu.br', 1),
	(6, '12345678', 'Felipe Costa Andrade', '678.901.234-55', 'felipe.andrade@escola.edu.br', 11),
	(7, '12345678', 'Gabriela Pinto Rocha', '789.012.345-66', 'gabriela.rocha@escola.edu.br', 11),
	(8, '12345678', 'Henrique Lima Tavares', '890.123.456-77', 'henrique.tavares@escola.edu.br', 11),
	(9, '12345678', 'Isabela Gomes Ferreira', '901.234.567-88', 'isabela.ferreira@escola.edu.br', 11),
	(10, '12345678', 'João Paulo Meireles', '012.345.678-99', 'joao.meireles@escola.edu.br', 11),
	(11, '34567890', 'Rafael Augusto Nogueira', '798.102.435-66', 'rafael.nogueira@escola.edu.br', 10),
	(12, '45678901', 'Sandra Helena Tavares', '809.213.546-77', 'sandra.tavares@escola.edu.br', 10),
	(13, '45678901', 'Tiago Nascimento Luz', '910.324.657-88', 'tiago.luz@escola.edu.br', 10),
	(14, '45678901', 'Vanessa Prado Oliveira', '021.435.768-99', 'vanessa.oliveira@escola.edu.br', 10),
	(15, '45678901', 'Wagner Souza Ribeiro', '132.546.879-10', 'wagner.ribeiro@escola.edu.br', 10),
	(16, '56789012', 'Aline Martins Teixeira', '243.657.980-21', 'aline.teixeira@escola.edu.br', 10),
	(17, '78901234', 'Hugo Pereira Bastos', '910.324.657-98', 'hugo.bastos@escola.edu.br', 11),
	(18, '78901234', 'Ingrid Castro Almeida', '021.435.768-09', 'ingrid.almeida@escola.edu.br', 11),
	(19, '78901234', 'Jorge Matos Figueira', '132.546.879-19', 'jorge.figueira@escola.edu.br', 11),
	(20, '78901234', 'Kelly Souza Ribeiro', '243.657.980-29', 'kelly.ribeiro@escola.edu.br', 11),
	(21, '89012345', 'Lucas Ramos Andrade', '354.768.091-39', 'lucas.andrade@escola.edu.br', 11),
	(22, '89012345', 'Mirela Duarte Costa', '465.879.102-49', 'mirela.costa@escola.edu.br', 1),
	(23, '89012345', 'Nelson Vieira Martins', '576.980.213-53', 'nelson.martins@escola.edu.br', 1),
	(24, '89012345', 'Olívia Nogueira Lima', '687.091.324-64', 'olivia.lima@escola.edu.br', 1),
	(25, '89012345', 'Paulo César Barros', '798.102.435-75', 'paulo.barros@escola.edu.br', 1),
	(26, '90123456', 'Renata Oliveira Braga', '809.213.546-86', 'renata.braga@escola.edu.br', 1),
	(27, '90123456', 'Sérgio Tavares Rocha', '910.324.657-97', 'sergio.rocha@escola.edu.br', 10),
	(28, '90123456', 'Tatiane Freitas Mendes', '021.435.768-08', 'tatiane.mendes@escola.edu.br', 10),
	(29, '90123456', 'Ubirajara Gonçalves Neto', '132.546.879-18', 'ubirajara.neto@escola.edu.br', 10);
...
-- Copiando dados para a tabela sap_tea.migrations: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela sap_tea.perfil_estudante: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela sap_tea.personalidade: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela sap_tea.serie: ~9 rows (aproximadamente)
...
-- Copiando dados para a tabela sap_tea.tipo_funcao: ~11 rows (aproximadamente)
INSERT INTO `tipo_funcao` (`tipo_funcao_id`, `desc_tipo_funcao`) VALUES
	(1, 'Diretor(a) / Gestor(a) de Escola'),
	(2, 'Vice diretor(a) de escola'),
	(3, 'Coordenador(a)'),
	(4, 'Supervisor(a) da escola'),
	(5, 'Professor(a)'),
	(6, 'Professor(a) AEE'),
	(7, 'Psicopedagogo(a)'),
	...
	(9, 'Psicologo(a)'),
	(10, 'Fonoaudiologo(a)'),
	(11, 'Coordenador(a) AEE'),
	(12, 'Professor(a) Regular / Especialista');
...
-- Copiando dados para a tabela sap_tea.turma: ~16 rows (aproximadamente)
