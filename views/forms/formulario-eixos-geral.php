    ...
    try {
        ...
        if ($result) {
            ...
            <div style="background-color: #f0f0f0; padding: 15px; margin-bottom: 20px; border: 1px solid #ddd; border-radius: 5px;">
                <h2 style="margin-top: 0;">SONDAGEM PEDAGÓGICA 1 - INICIAL</h2>
...
<button type="button" class="cancel-button" onclick="window.location.href='/proj_foccus/index.php'">Cancelar</button>
